...
(function (LZUTF8) {
    ...
    function runningInWebWorker() {
        return typeof self == "object" && self.document === undefined && self.addEventListener != undefined;
    }
        ...
        CLI.start = function () {
            ...
            if (command == "c") {
                ...
                compressionCorrectnessTestStream.on("close", function () {
                    ...
                    var temporaryFileContent = new Uint8Array(NodeFS.readFileSync(temporaryFilePath_1));
    ...
    var AsyncCompressor = (function () {
        ...
        AsyncCompressor.createCompressionStream = function () {
            ...
            compressionStream._transform = function (data, encoding, done) {
                var buffer;
                try {
                    buffer = new Buffer(compressor.compressBlock(new Uint8Array(data)));
                }
                catch (e) {
    ...
    var AsyncDecompressor = (function () {
        ...
        AsyncDecompressor.createDecompressionStream = function () {
            ...
            decompressionStream._transform = function (data, encoding, done) {
                var buffer;
                try {
                    buffer = new Buffer(decompressor.decompressBlock(new Uint8Array(data)));
                }
                catch (e) {
    ...
    var CompressionCommon = (function () {
        ...
        CompressionCommon.encodeCompressedBytes = function (compressedBytes, outputEncoding) {
            switch (outputEncoding) {
                ...
                case "Buffer":
                    return this.uint8ArrayToBuffer(compressedBytes);
                case "BinaryString":
        ...
        CompressionCommon.encodeDecompressedBytes = function (decompressedBytes, outputEncoding) {
            switch (outputEncoding) {
                ...
                case "Buffer":
                    return this.uint8ArrayToBuffer(decompressedBytes);
                case "String":
        ...
        CompressionCommon.uint8ArrayToBuffer = function (arr) {
            if (Buffer.prototype instanceof Uint8Array) {
                // A simple technique based on how buffer objects are created in node 3/4+
                // See: https://github.com/nodejs/node/blob/master/lib/buffer.js#L22
    ...
    var EventLoop = (function () {
        ...
        EventLoop.initializeScheduler = function () {
            ...
            if (LZUTF8.runningInNodeJS()) {
                ...
                this.asyncFlushFunc = function () { return window.postMessage(token_1, window.location.href); };
            }
